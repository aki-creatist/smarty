...
<form method="post" action="">
    <table>
        ...
        <tr>
            ...
            <td>
                {html_radios name="gender" options=$genders selected=$select_gender }
        ...
        <tr>
            ...
            <td>
                <select name="year" >
                    {html_options options=$date[0] selected=$select_date['year'] }
                </select>
                <select name='month'>
                    {html_options options=$date[1] selected=$select_date['month'] }
                </select>
                <select name='day'>
                    {html_options options=$date[2] selected=$select_date['day'] }
                </select>
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
            {html_checkboxes name=traffic options=$traffics checked=$select_traffic }
